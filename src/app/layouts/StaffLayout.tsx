    ...
    <div className="app-layout">
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .staff-topbar-toggle { background:none; border:1px solid var(--border); border-radius:8px; padding:7px; cursor:pointer; color:var(--muted); display:flex; align-items:center; }
