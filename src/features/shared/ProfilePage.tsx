      ...
      <div className="prof-page">
        ...
        <div className="prof-card">
          ...
          <div className="prof-field">
            ...
            <input className="prof-input" value={displayName} disabled />
          </div>
          <div className="prof-field">
            <label className="prof-label">Role</label>
            <input className="prof-input" value={roleLabel[role] ?? role} disabled />
          </div>
          <div className="prof-field">
        ...
        <div className="prof-card">
          ...
          {!pwStep ? (
            ...
            <>
              ...
              {pwSaved && <div className="prof-success">Profile updated successfully</div>}
